//creating array
disp("Creating 3*3 matrix {Array}")
A=[1,2,3;4,9,6;7,8,9]
B=[1,2,3;4,2,3;1,9,3]
...
//Add A+B
disp("Addition of two Array is A+B : ")
disp(A+B)

//Multiply A*B
disp("Multiplication is A*B : ")
disp(A*B)

// Multiplying individual elements of A with B
disp("Multiply INDIVIDUAL Number A.*B : ")
disp(A.*B)

//Square of individual elements
disp("SQUARE OF individual EleMEnt A.^A : ")
disp(A.^2)
